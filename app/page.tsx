...
const steps = [
  ...
  },
  {
    ...
    description: "Bandhanaa helps with the introduction. What happens next stays yours.",
  },
];
      ...
      <main>
          ...
          <div className={styles.heroGrid}>
            <div className={styles.heroCopy}>
              <div className={styles.heroCopyInner} data-home-reveal>
                ...
                <h1 className={`${styles.serif} ${styles.heroTitle}`}>
                  Marriage begins
                  <br />
                  with the right
                  <br />
                ...
                <div className={styles.benefits}>
                  <span className={styles.benefit}>
                    <UserRound size={15} strokeWidth={1.7} /> Free to register
                  </span>
                  <span className={styles.benefit}>
                    <Heart size={15} strokeWidth={1.7} /> Free to connect
                  </span>
                  <span className={styles.benefit}>
                    <ShieldCheck size={15} strokeWidth={1.7} /> Privacy controls built in
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className={styles.heroVisual}>
              <Image
                src="/bandhanaa-register-hero-full.png"
              ...
              <div className={styles.profileFloat}>
                <div className={styles.profileTop}>
                  ...
                  <div>
                    <div className={styles.profileName}>
                      Ananya, 26 <BadgeCheck size={13} color="#e83e78" fill="#e83e78" />
                    </div>
                ...
                <div className={styles.tags}>
                  <span className={styles.tag}>♡ Values</span>
            ...
            <div data-home-reveal>
              ...
              <div className={styles.menu}>
                {[
                  ...
                  [Heart, "Matches"],
                  [UserRound, "Profile"],
                  [MessageSquare, "Requests"],
                  [MessageSquare, "Messages"],
                ].map(([Icon, label], index) => {
                  const MenuIcon = Icon as typeof Search;
                  return (
                    <div
                      key={label as string}
                      className={`${styles.menuItem} ${index === 0 ? styles.menuItemActive : ""}`}
                    >
                      <MenuIcon size={17} strokeWidth={1.6} />
                      <span>{label as string}</span>
                      {index === 0 && <span style={{ marginLeft: "auto" }}>→</span>}
                    </div>
                  );
                })}
              </div>
            ...
            <div className={styles.deviceStage} data-home-reveal>
              <div className={styles.laptop}>
                ...
                <div className={styles.filters}>
                  ...
                  <span className={styles.filter}>Near you</span>
                  <span className={styles.filter}>New members</span>
                  <span className={styles.filter}>Verified</span>
                </div>
                  ...
                  {showcaseProfiles.map((profile) => (
                    <article key={profile.name} className={styles.profileCard}>
                      <div className={styles.profilePhotoWrap}>
                        <Image src={profile.src} alt={profile.name} fill sizes="220px" />
                      </div>
                      <div className={styles.profileCardBody}>
                        ...
                        <p className={styles.match}>{profile.match}</p>
                      </div>
                    </article>
                  ))}
                </div>
              ...
              <div className={styles.phone}>
                ...
                <div className={styles.phoneImage}>
                  <Image src="/profiles/rohan.png" alt="Karthik profile" fill sizes="180px" />
                </div>
                <div className={styles.phoneBody}>
                  ...
                  <p>
                    <strong>About</strong>
                    <br />
                    Kind, honest, and values family and meaningful conversations…
                  </p>
        ...
        <section className={styles.compat}>
          <div className={styles.compatGrid}>
            ...
            <div className={styles.compatTiles} data-home-reveal>
              {compatibilityItems.map(({ icon: Icon, label }) => (
                <div key={label} className={styles.compatTile}>
          ...
          <div className={styles.howInner}>
            ...
            <div className={styles.steps}>
              {steps.map(({ number, icon: Icon, title, description }) => (
                <article key={number} className={styles.step} data-home-reveal>
        ...
        <section className={styles.horoscope}>
          <div className={`${styles.decorLeaf} ${styles.leaf1}`} aria-hidden="true" />
          <div className={`${styles.decorLeaf} ${styles.leaf2}`} aria-hidden="true" />
          <div className={styles.zodiacDisc} aria-hidden="true" />

          <div className={styles.horoscopeGrid}>
            <div className={styles.tabletStage} data-home-reveal>
              <div className={styles.tablet}>
                <div className={styles.tabs}>
                  <span className={styles.tabActive}>Chart</span>
                  <span>Details</span>
                  <span>Compatibility</span>
                </div>

                <div className={styles.horoscopeContent}>
                  <div className={styles.chart} aria-label="Horoscope chart preview">
                    <span className={styles.chartLabel}>Ra</span>
                    <span className={styles.chartLabel}>Sa</span>
                    <span className={styles.chartLabel}>Me</span>
                    <span className={styles.chartLabel}>Ke</span>
                    <span className={styles.chartLabel}>Su</span>
                  </div>

                  <div className={styles.detailGrid}>
                    <div className={styles.detail}>Rasi<strong>Mithuna</strong></div>
                    <div className={styles.detail}>Nakshatra<strong>Arudra</strong></div>
                    <div className={styles.detail}>Lagna<strong>Tula</strong></div>
                    <div className={styles.detail}>Navamsa<strong>Kumbha</strong></div>
                    <div className={styles.compatBar}>
                      Compatibility <strong>Good Match</strong>
        ...
        <section id="safety" className={styles.safety}>
          <div className={styles.safetyGrid}>
            <div className={styles.safetyCopy} data-home-reveal>
              ...
              <h2 className={`${styles.serif} ${styles.safetyTitle}`}>
                Your profile.
                <br />
                Your boundaries.
              </h2>
              ...
              <div className={styles.privacyCards}>
                {privacyItems.map(({ icon: Icon, label }) => (
                  <div key={label} className={styles.privacyCard}>
            ...
            <div className={styles.safetyVisual}>
              <Image
                ...
                alt="Couple in conversation"
                fill
                sizes="(max-width: 1023px) 100vw, 44vw"
              />
              <div className={styles.safetyNote}>Good{"\n"}People{"\n"}Brighter{"\n"}Tomorrows</div>
            </div>
          </div>
        </section>
        ...
        <section className={styles.access}>
          <div className={styles.accessGrid} data-home-reveal>
            ...
            <div className={styles.accessRight}>
              <p>
                Create your profile for free. Discover people, send requests and start meaningful
                conversations when there’s mutual interest.
              </p>
              <div className={styles.accessFeatures}>
                {[
                  ...
                  <span key={item}><span className={styles.check}>✓</span> {item}</span>
                ))}
              </div>
            </div>
          </div>
        ...
        <section className={styles.finalCta}>
          <div className={styles.finalCtaInner} data-home-reveal>
            ...
            <h2 className={`${styles.serif} ${styles.finalTitle}`}>
              Someone meaningful could start with <em>hello.</em>
            </h2>
            <div className={styles.finalActions}>
              <Link href="/register" className={styles.pill}>
                Create your Bandhanaa profile <span>→</span>
              </Link>
              <span>
                Already a member? <Link href="/login" style={{ textDecoration: "underline" }}>Sign in</Link>
              </span>
            </div>
          </div>

          <svg className={styles.wave} viewBox="0 0 1600 120" preserveAspectRatio="none" aria-hidden="true">
            <path
              d="M-20 65 C95 0,150 15,215 62 C290 118,370 108,500 90 C700 63,850 90,1000 103 C1185 121,1320 106,1425 58 C1495 27,1545 14,1625 42"
              fill="none"
              stroke="#f06b8c"
              strokeWidth="2.2"
            />
