  ...
  return (
    <section className="rounded-2xl border border-[#e6edf2] bg-white p-5 shadow-[0_8px_24px_rgba(15,20,25,.035)]">
      <div className="flex justify-between">
        ...
        <Link href={`/settings/edit-profile?section=${encodeURIComponent(editSection ?? title)}`} className="flex h-7 items-center gap-1 rounded-lg border border-[#e33d92] bg-[#ffe2ef] px-3 text-[13px] font-semibold text-[#e33d92] transition-colors hover:bg-[#ffd4e7] focus-visible:bg-[#ffd4e7]">
          <Pencil size={10} />
          Edit
        </Link>
      </div>
