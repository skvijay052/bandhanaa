  ...
  return (
    <header className={styles.header}>
      <div className={styles.inner}>
        ...
        <nav className={styles.desktopNav} aria-label="Discover matrimony navigation">
          {navItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
        ...
        <button
          ...
          aria-expanded={open}
          aria-controls="discover-matrimony-mobile-menu"
      ...
      <aside
        id="discover-matrimony-mobile-menu"
      ...
      >
        ...
        <nav className={styles.mobileNav} aria-label="Mobile discover matrimony navigation">
          {navItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
