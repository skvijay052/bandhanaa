...
const navItems = [
  { label: "Discover", href: "/discover-matrimony", active: false },
  { label: "How it works", href: "/how-it-works", active: false },
  { label: "Safety", href: "/safety", active: true },
  ...
  return (
    <header className={styles.header}>
      <div className={styles.inner}>
        ...
        <nav className={styles.desktopNav} aria-label="Safety navigation">
          {navItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
        ...
        <button
          ...
          aria-expanded={open}
          aria-controls="safety-mobile-menu"
      ...
      >
        ...
        <nav className={styles.mobileNav} aria-label="Mobile safety navigation">
          {navItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
